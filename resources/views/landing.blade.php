    ...
    <div class="relative overflow-hidden bg-gradient-to-b from-slate-50 via-white to-slate-100">
        ...
        <main class="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 lg:py-20">
            <div class="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                <div class="space-y-6">
                    <div class="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-blue-100 bg-blue-50 text-blue-700 text-sm font-semibold">
                        <span class="h-2 w-2 rounded-full bg-blue-500 animate-pulse"></span>
                        Layanan kampus yang sigap
                    </div>
                    <h1 class="text-4xl sm:text-5xl lg:text-6xl font-bold leading-tight text-slate-900">
                ...
                <div class="relative">
                    ...
                    <div class="relative bg-white rounded-3xl border border-slate-200 shadow-2xl shadow-blue-500/10 overflow-hidden">
                            ...
                            @foreach ($sampleTickets as $ticket)
                                <div class="flex items-start gap-3 p-4 rounded-xl border border-slate-100 bg-slate-50/60">
                                    ...
                                    <div class="flex-1">
                                        ...
                                        <p class="text-sm text-slate-500">{{ $ticket['time'] }}</p>
                                    </div>
                                    <span class="px-3 py-1 rounded-full text-xs font-semibold {{ $statusColors[$ticket['status']] ?? 'bg-slate-100 text-slate-800' }}">
                                        {{ $ticket['status'] }}
                                    </span>
                                </div>
                            @endforeach
                                ...
                                @foreach ($progress as $item)
                                    <div class="p-4 rounded-xl bg-white/10 border border-white/10">
                                        ...
                                        <div class="w-full h-2.5 rounded-full bg-white/10 overflow-hidden">
                                            <div class="h-full rounded-full bg-gradient-to-r {{ $item['color'] }}" style="width: {{ $item['value'] }}%"></div>
                                        </div>
                                    </div>
                                @endforeach
                            </div>
